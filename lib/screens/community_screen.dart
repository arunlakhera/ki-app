        ...
        children: [
          ...
          Expanded(
            child: _activeTab == 0
                ? const _FeedTab()
                : _EmptyTab(
                    label: _activeTab == 1 ? 'No posts yet' : 'No saved posts',
                  ),
          ),
        ],
      ),
    ...
    return ListView(
      ...
      children: [
        _PostCard(
          ...
          text:
              'Proud to finish this 3BHK project in Mumbai. Great team effort!',
        ...
        _PostCard(
          ...
          text:
              'Available for residential wiring work in Pune next week. 5 years exp.',
    ...
    return Center(
      child: Column(
        ...
        children: [
          ...
          Text(
            label,
            style: TextStyle(color: context.tc.textGrey, fontSize: 15),
          ),
        ],
      ),
    );
          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                Text(
                  'New Safety Certification course now available.',
                  style: TextStyle(
                    color: tc.textWhite,
                ...
                Text(
                  'Enhance your professional standing today.',
...
class _PostCard extends StatefulWidget {
  ...
  const _PostCard({
    ...
    required this.text,
    this.avatarColor = AppColors.inputBackground,
    this.avatarInitials = '',
      ...
      child: Column(
        ...
        children: [
          ...
          Padding(
            ...
            child: Text(
              widget.text,
              style: TextStyle(color: tc.textWhite, fontSize: 14, height: 1.5),
            ),
          ),
          if (widget.hasImage) ...[
                    ...
                    child: Row(
                      children: [
                        Icon(
                          ...
                          color: _liked ? primary : tc.textGrey,
                          size: 18,
                        ),
