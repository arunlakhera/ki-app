        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              ...
              style: TextStyle(color: tc.textGrey, fontSize: 14),
            ),
            ...
            _TypeCard(
              ...
              subtitle:
                  'Find jobs, build your profile and earn through your skills.',
            ...
            _TypeCard(
              ...
              subtitle:
                  'Post jobs, find skilled workers and manage your projects.',
    ...
    return GestureDetector(
      ...
      child: AnimatedContainer(
        ...
        decoration: BoxDecoration(
          ...
          border: Border.all(
            color: selected ? primary : tc.borderColor,
            width: selected ? 2 : 1,
          ),
        ),
        child: Row(
          children: [
            Container(
              ...
              child: Icon(
                icon,
                color: selected ? primary : tc.textGrey,
                size: 26,
              ),
            ),
